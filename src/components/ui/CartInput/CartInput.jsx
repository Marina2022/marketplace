    ...
    <div className={`${s.wrapper} ${className}`}>
      <div className={s.inputWrapper}>
        <button onClick={onMinusClick} className={s.minusBtn}>
          <svg className={s.minusSvg} width="6" height="3" viewBox="0 0 6 3" fill="none"
        ...
        <button disabled={inputValue === product.inventoryQuantity} onClick={onPlusClick} className={s.plusBtn}>
          <svg className={s.plusSvg} width="9" height="9" viewBox="0 0 9 9" fill="none"
               xmlns="http://www.w3.org/2000/svg">
            <path
