import s from './DashboardTablet.module.scss';
...
const DashboardTablet = ({data,  setRequestToEdit}) => {
  return (
    <div className={s.dashboardTablet}>
      <div className={s.header}>
        <div className={s.title}>Обзор</div>
        <div className={s.subtitle}>{dashboardFormatDateRu(data.date)}</div>
      </div>
      <div className={`${s.dashboardTabletContent} scroll`}>
