...
const UserDropdown = () => {
  ...
  return (
    <div
      ref={dropdownRef}
      className={s.userDropdownWrapper}
    >
      <button
        className={`${s.userDropdownBtn} ${isDropdownOpen ? s.userDropdownBtnClicked : ''}`}
        ...
        <div className={s.dropWrapper}>
          <div className={s.dropdown}>
            <div className={s.activeProfile}>
              <div className={s.subtitle}>Активный профиль</div>
            ...
            <div className={s.personalProfile} onClick={() => profileItemClickHandler(personalAccount.profileId)}>
              <div className={s.subtitle}>Личный аккаунт</div>
            ...
            </div>
            {
              companyProfiles.length > 0 && (
                <div className={s.companiesProfile}>
                  <div className={`${s.subtitle} ${s.subtitleCompanies}`}>
                    <span>Компании</span>
