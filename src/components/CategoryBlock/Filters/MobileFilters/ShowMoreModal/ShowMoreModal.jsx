import s from './ShowMoreModal.module.scss';
import BackButton from "@/components/CategoryBlock/Filters/MobileFilters/BackButton/BackButton.jsx";

const ShowMoreModal = ({isOpen, setIsOpen, children, title}) => {
  return (
      isOpen && <div>
