...
const ProductPhotoContainer = ({index, productPhotos, setPopupOpen, setProductPhotos}) => {
  ...
  return (
    <li className={`${s.productPhotoContainer} ${firstEmpty ? s.firstEmpty : ''}`} onClick={handleClick}>
      ...
      {
        !isEmpty && <button className={s.mobileDeleteBtn} onClick={handleDelete} type="button">
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13 1L1 13M1.00001 1L13 13" stroke="#3E5067" strokeWidth="1.5" strokeLinecap="round"
      ...
      {
        !isEmpty && <button onClick={handleDelete} type="button" className={s.deleteBtn}>
