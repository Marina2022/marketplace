  ...
  return (
    <div className={s.productPhotosWrapper}>
      ...
      <div className={s.textBlock}>
        Эти изображения используются в описании товара, чтобы показать его преимущества, особенности и детали. <span className={s.mobileHidden}>Первое
        фото станет главным в описании. Остальные изображения можно расположить в том порядке, который лучше всего
        раскрывает особенности товара.</span>
      </div>
    </div>
  )
}
