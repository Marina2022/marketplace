  ...
  return (
    <div className={s.mainCategoryWrapper}>
      ...
      <div className={s.mainCatHeader} onClick={handleClick}>
        <svg className={open ? s.arrowBtnOpened : s.arrowBtn} width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
...

      {
        open && <ul className={s.subCats}>
          {
            cat.subCategories.map(subCat => <SubCategory key={subCat.subCategoryId} subCat={subCat}/>)
          }
        </ul>
      }
