...
const SubCategory = ({subCat, searchCats, lastOne, selectedCatId, setSelectedCatId}) => {
  ...
  return (
    <div className={s.subCategoryWrapper}>
      ...
      <div className={s.outerWrapper}>
        ...
        {
          subCatOpen && <ul className={s.list}>
            {
              subCat.productCategories.map((productCategory, i) => <ProductCategory
