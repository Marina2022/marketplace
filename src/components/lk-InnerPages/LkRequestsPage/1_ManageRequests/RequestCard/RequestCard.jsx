      ...
      <div className={s.bottomBlock}>
        ...
        <button className={s.bottomButton}>
          <svg width="9" height="18" viewBox="0 0 9 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.5975 8.66844C8.5975 9.36844 8.3275 10.0684 7.7975 10.5984L1.2775 17.1184C0.987499 17.4084 0.5075 17.4084 0.2175 17.1184C-0.0725 16.8284 -0.0725 16.3484 0.2175 16.0584L6.7375 9.53844C7.2175 9.05844 7.2175 8.27844 6.7375 7.79844L0.2175 1.27844C-0.0725 0.988438 -0.0725 0.508438 0.2175 0.218437C0.5075 -0.0715637 0.987499 -0.0715637 1.2775 0.218437L7.7975 6.73844C8.3275 7.26844 8.5975 7.96844 8.5975 8.66844Z" fill="black"/>
          </svg>
        </button>
      </div>
