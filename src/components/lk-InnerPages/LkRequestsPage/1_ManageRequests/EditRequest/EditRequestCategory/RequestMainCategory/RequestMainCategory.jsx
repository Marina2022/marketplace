import s from './RequestMainCategory.module.scss';
import {useEffect, useState} from "react";
import RequestSubCategory
  from "@/components/lk-InnerPages/LkRequestsPage/1_ManageRequests/EditRequest/EditRequestCategory/RequestSubCategory/RequestSubCategory.jsx";

const RequestMainCategory = ({cat, searchCats, selectedCatId, setSelectedCatId}) => {
      ...
      <div className={s.outerWrapper}>
        <div className={s.verticalLine}></div>
        {
          open && <ul className={s.subCats}>
            {
              cat.subCategories.map((subCat, i) => <RequestSubCategory
