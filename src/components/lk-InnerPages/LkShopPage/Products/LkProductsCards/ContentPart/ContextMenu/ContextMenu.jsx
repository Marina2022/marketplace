...
//
// const ContextMenu = ({product, linked=false}) => {
//  
...
//
//       {
//         open && <div className={s.menuBlock}>
//
//           {
//             linked && <ul>Пункты для линкованного товара</ul>
//           }
//
//           {
//             !linked && product.productStatus !== 'В архиве' && <ul>Пункты для обычного товара</ul>
//           }
//
//           {
//             !linked && product.productStatus === 'В архиве' && <ul>Пункт для товара в архиве</ul>
//           }
//          
//         </div>
//       }
...
const ContextMenu = ({product, linked = false, getProducts}) => {
  ...
  const handleArchive = async() => {
    // axiosInstance.post(`/seller/${profileId}/products/${product.productVariantId}/copy`)
    axiosInstance.post(`/seller/product/${product.productVariantId}/archivate`)
      ...
      {open && (
        <div className={s.menuBlock}>
          ...
          {linked && <ul>
            <li onClick={handleEdit} className={s.menuItem}>Редактировать товар</li>
            <li onClick={handleCopy} className={s.menuItem} >Создать копию</li>
            <li className={s.menuItem}>Отвязать товар</li>
          </ul>}
        </div>
      )}
    </div>
