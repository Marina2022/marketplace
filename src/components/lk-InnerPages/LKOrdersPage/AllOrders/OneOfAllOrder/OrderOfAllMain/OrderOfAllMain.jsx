...
const OrderOfAllMain = ({order, productListIsOpen, setProductListIsOpen}) => {
  ...
  // const testArr = [...order.productImages, ...order.productImages, ...order.productImages,]
...

        {
          order.orderStatus !== "canceled" && (
            <div className={s.docs}>
              ...
              <a download target="_blank" href={`${BASE_URL}${order.orderBilsLink.slice(1)}`}>Документы по заказу</a>
            </div>
          )
        }
