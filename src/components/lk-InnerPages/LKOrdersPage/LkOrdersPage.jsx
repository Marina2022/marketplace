        ...
        <div className={s.content}>
          ...
          </div>
          {
            topTabs === 1 && <div className={s.ordersTabs}>
              <div onClick={() => dispatch(setOrdersTab(1))}
                   className={ordersTab === 1 ? s.activeOrderTab : s.orderTab}>Активные
                заказы
              </div>
              <div onClick={() => dispatch(setOrdersTab(2))}
                   className={ordersTab === 2 ? s.activeOrderTab : s.orderTab}>Все заказы
              </div>
            </div>
          }
