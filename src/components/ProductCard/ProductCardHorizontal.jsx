...
const ProductCardHorizontal = ({product, quantity, onFavClick, onAddToCartClick, cartItemId, isFavourite}) => {
      ...
      <div className={s.priceAndCartBlock}>
        ...
        <div className={s.btnWrapper}>
...

          {
            ...
            >
              {
                cartUpdatingStatus === 'loading' ? <MiniSpinner/> : <span>В&nbsp;корзину</span>
              }
          ...
          <button className={s.favBtn} onClick={onFavClick}>
            ...
            {
              !isFavourite && <svg className={s.favoriteIcon} width="22" height="20" viewBox="0 0 22 20"
